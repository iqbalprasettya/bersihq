    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                            ...
                                            <div class="max-w-md mx-auto">
                                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                                    <div class="flex">
                                                        ...
                                                        <div class="ml-3">
                                                            <h3 class="text-sm font-medium text-blue-800">Cara
                                                                Menghubungkan
                                                                WhatsApp</h3>
                ...
                <!-- Device Info Section -->
                <div class="bg-white rounded-2xl shadow-sm" x-data="deviceInfo()">
                    <div class="px-6 py-4 border-b border-gray-100">
                        <h2 class="text-lg font-medium text-gray-900">Informasi Device</h2>
                    </div>
                    <div class="p-6">
                        <template x-if="loading">
                        ...
                        <template x-if="!loading && !error && deviceData">
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Nomor WhatsApp</div>
                                        <div class="mt-1 text-lg font-semibold text-gray-900" x-text="deviceData.device">
                                        </div>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Status Device</div>
                                        <div class="mt-1">
                                            <span x-show="deviceData.device_status === 'connect'"
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                                                <svg class="w-2 h-2 mr-1.5 text-emerald-400" fill="currentColor"
                                                    viewBox="0 0 8 8">
                                                    <circle cx="4" cy="4" r="3" />
                                                </svg>
                                                Terhubung
                                            ...
                                            <span x-show="deviceData.device_status !== 'connect'"
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                <svg class="w-2 h-2 mr-1.5 text-gray-400" fill="currentColor"
                                                    viewBox="0 0 8 8">
                                                    <circle cx="4" cy="4" r="3" />
                                                </svg>
                                                Tidak Terhubung
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Nama Device</div>
                                        <div class="mt-1 text-lg font-semibold text-gray-900" x-text="deviceData.name">
                                        </div>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Paket</div>
                                        <div class="mt-1 text-lg font-semibold text-gray-900" x-text="deviceData.package">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Kuota Pesan</div>
                                        <div class="mt-1 text-lg font-semibold text-gray-900" x-text="deviceData.quota">
                                        </div>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <div class="text-sm font-medium text-gray-500">Total Pesan Terkirim</div>
                                        <div class="mt-1 text-lg font-semibold text-gray-900"
                                            x-text="deviceData.messages"></div>
                                    </div>
                                </div>

                                <div class="bg-gray-50 rounded-lg p-4">
                                    <div class="text-sm font-medium text-gray-500">Plan</div>
                                    <div class="mt-1 text-lg font-semibold text-gray-900" x-text="deviceData.expired">
                                    </div>
                                </div>
                            </div>
                        </template>
                        ...
                        <div class="mt-6 flex justify-center">
                            <button @click="getDeviceInfo" type="button"
                                class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-colors duration-150"
                                :disabled="loading">
                                <template x-if="loading">
                                    <svg class="animate-spin h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span x-text="loading ? 'Memuat...' : 'Refresh Info'"></span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                return {
                    ...
                    async getDeviceInfo() {
                        try {
                            ...
                            const response = await fetch('{{ route('whatsapp.connect.device') }}', {
                                method: 'POST',
                                headers: {
                            ...
                            this.error = 'Terjadi kesalahan saat memuat informasi device';
