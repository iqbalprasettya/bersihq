...
@section('title', 'Edit Pengguna - BersihQ Laundry')
...
@section('content')
    <div class="max-w-3xl mx-auto space-y-4 pb-20">
        ...
        <nav class="bg-white shadow-sm rounded-2xl p-4 flex items-center space-x-3 text-base">
            ...
            <span class="text-green-600 font-semibold">Edit Pengguna</span>
        </nav>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                value="{{ old('nama', $user->nama) }}" placeholder="Masukkan nama pengguna" required>
                            @error('nama')
