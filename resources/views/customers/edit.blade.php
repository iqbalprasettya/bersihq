...
@section('title', 'Edit Pelanggan - BersihQ Laundry')
...
@section('content')
    <div class="max-w-3xl mx-auto space-y-4 pb-20">
        ...
        <nav class="bg-white shadow-sm rounded-2xl p-4 flex items-center space-x-3 text-base">
            ...
            <span class="text-green-600 font-semibold">Edit Pelanggan</span>
        </nav>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                value="{{ old('nama', $customer->nama) }}" placeholder="Masukkan nama pelanggan" required>
                            @error('nama')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="no_wa" id="no_wa"
                                    ...
                                    value="{{ old('no_wa', substr($customer->no_wa, 2)) }}" placeholder="8xxxxxxxxxx"
                                    required>
                            </div>
                            @error('no_wa')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
