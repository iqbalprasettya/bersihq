                        ...
                        <div class="flex flex-col gap-4">
                            @foreach ($latestOrders as $order)
                                <div
                                    ...
                                    <div
                                        class="hidden sm:flex flex-shrink-0 w-10 h-10 rounded-full bg-green-100 items-center justify-center text-green-800 font-bold text-base">
                                    ...
                                    <a href="{{ route('orders.index') }}" class="absolute inset-0 z-10"
